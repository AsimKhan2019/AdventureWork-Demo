var JamuroAdventuresWorksSimpleDemo = JamuroAdventuresWorksSimpleDemo || {};

JamuroAdventuresWorksSimpleDemo.createNameSpace = function (namespace) {

	//get the namespace string and split it
	var namespaceArr = namespace.split('.');
	var parent = JamuroAdventuresWorksSimpleDemo;

	// excluding the parent
	if (namespaceArr[0] === 'JamuroAdventuresWorksSimpleDemo') {
...
JamuroAdventuresWorksSimpleDemo.createNameSpace("Cookies");

JamuroAdventuresWorksSimpleDemo.Cookies.getCookie = function (ck_name) {
...
JamuroAdventuresWorksSimpleDemo.Cookies.setCookie = function (ck_name, value, exdays) {
	var exdate = new Date();
